...
func unflatten2DString(SliceToRead []byte, row int, columns int) (SliceReaded []byte, element [][]string) {

	element = make([][]string, row)

	for i := range element {

		SliceToRead, element[i] = unflatten1DString(SliceToRead, columns)
